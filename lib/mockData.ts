...
export const initialCourses: Course[] = [
  {
    ...
    materials: [
      { id: "m1", title: "微观经济学第5章-市场均衡与弹性.pdf", type: "pdf", size: "3.4 MB", uploadDate: "2025-05-15" },
      { id: "m2", title: "博弈论与纳什均衡讲义.ppt", type: "ppt", size: "8.1 MB", uploadDate: "2025-05-18" },
    ],
  },
  {
    id: "c2",
    ...
    materials: [
      { id: "m3", title: "偏导数与全微分精讲.pdf", type: "pdf", size: "4.2 MB", uploadDate: "2025-05-10" },
      { id: "m4", title: "重积分计算技巧与习题解答.pdf", type: "pdf", size: "5.6 MB", uploadDate: "2025-05-14" },
    ],
  },
  {
    id: "c3",
    ...
    classroom: "外语楼 207",
    credit: 2,
    bgHex: "#F0EBE1",      // Soft warm beige
    borderHex: "#E0D7C6",
    textHex: "#313032",
    description: "Focuses on academic presentation, spontaneous discourse, debate skills, and cross-cultural communication.",
    materials: [
      { id: "m5", title: "Unit 6 Presentation Guidelines.pdf", type: "pdf", size: "1.8 MB", uploadDate: "2025-05-12" },
      { id: "m6", title: "Academic Vocabulary & Phrasebank.doc", type: "doc", size: "650 KB", uploadDate: "2025-05-08" },
    ],
  },
  {
    id: "c4",
    ...
    materials: [
      { id: "m7", title: "Python数据处理与Pandas核心用法.ipynb", type: "doc", size: "2.1 MB", uploadDate: "2025-05-11" },
    ],
  },
  {
    id: "c5",
    ...
    materials: [
      { id: "m9", title: "经典管理学案例集解析.pdf", type: "pdf", size: "6.8 MB", uploadDate: "2025-05-09" },
    ],
  },
  {
    id: "c6",
    ...
    materials: [
      { id: "m10", title: "Stata回归分析与假设检验操作手册.pdf", type: "pdf", size: "7.9 MB", uploadDate: "2025-05-13" },
    ],
  },
  {
    id: "c7",
    ...
    materials: [
      { id: "m11", title: "品牌传播与社群营销案例库.ppt", type: "ppt", size: "9.3 MB", uploadDate: "2025-05-14" },
    ],
  },
  {
    id: "c8",
    ...
    materials: [
      { id: "m12", title: "SQL复杂查询与索引优化导图.pdf", type: "pdf", size: "3.1 MB", uploadDate: "2025-05-16" },
    ],
  },
];
...
export const initialAssignments: Assignment[] = [
  ...
  },
  {
    ...
    tags: ["小组作业", "PPT汇报"],
    subtasks: [
      { id: "st4", title: "确定分析品牌", completed: true },
...
export const initialCalendarMarks: CalendarMark[] = [
  { id: "cm1", date: "2025-05-19", type: "course", title: "微观经济学" },
  { id: "cm2", date: "2025-05-21", type: "ddl", title: "计量经济学作业截止" },
  { id: "cm3", date: "2025-05-22", type: "ddl", title: "市场营销案例汇报截止" },
  { id: "cm4", date: "2025-05-22", type: "course", title: "英语口语" },
  { id: "cm5", date: "2025-05-23", type: "ddl", title: "英语演讲PPT截止" },
  { id: "cm6", date: "2025-05-24", type: "ddl", title: "数据库实验报告截止" },
];
...
export const mockStudyLoadData = [
  ...
  { day: "周三", hours: 5.2, courseHours: 3.0, taskHours: 2.2 },
  { day: "周四", hours: 4.6, courseHours: 2.6, taskHours: 2.0 },
