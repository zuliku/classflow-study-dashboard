...
export const OPENCODE_MODELS: AIModelDefinition[] = [
  ...
  { id: "muse-spark-1.2", name: "Muse Spark 1.2", provider: "opencode-go", vendor: null, transport: "openai-chat", capabilities: { streaming: true, tools: true, vision: false, fileParts: false } },
];
