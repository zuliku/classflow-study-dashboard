 ...
 * 低噪声 Ghost 层级：无 shadow-subtle、无持续阴影。
 */
export function WorkspaceSearchButton() {
  ...
  return (
    <button
      ...
      onClick={openSearch}
      aria-label="全局搜索"
      className="flex h-8 items-center gap-1.5 rounded-lg border border-line bg-white px-2 text-xs text-sandrift transition-colors hover:border-line-strong hover:text-charcoal md:px-2.5"
    >
